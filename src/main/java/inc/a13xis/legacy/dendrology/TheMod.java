...
public final class TheMod {
	...
	static final String MOD_VERSION = "1.12-L1";
...
//        integrators.add(new StorageDrawersMod());
	...
	public void onFMLPreInitialization(FMLPreInitializationEvent event) {
		...
		ModBlocks.loadOverWorldContent();
		initIntegrators();
	...
	public String toString() {
		return MoreObjects.toStringHelper(this).add("creativeTab", creativeTab).add("integrators", integrators)
