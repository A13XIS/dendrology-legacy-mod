...
public final class ModBlocks {
	...
	public static void loadBlock(LeavesBlock leavesBlock) {
		leavesBlocks.add(leavesBlock);
	}

	public static void loadBlock(LogBlock logBlock) {
		logBlocks.add(logBlock);
	}

	public static void loadBlock(SaplingBlock saplingBlock) {
	...
	public static void loadBlock(StairsBlock stairsBlock) {
		stairsBlocks.add(stairsBlock);
	}

	public static void loadBlock(DoorBlock doorBlock) {
		doorBlocks.add(doorBlock);
	}

	public static void loadBlock(WoodBlock woodBlock) {
	...
	public static Iterable<? extends LeavesBlock> leavesBlocks() {
		return ImmutableList.copyOf(leavesBlocks);
	}

	public static Iterable<? extends WoodBlock> woodBlocks() {
		return ImmutableList.copyOf(woodBlocks);
	}

	public static Iterable<? extends SlabBlock> singleSlabBlocks() {
		return ImmutableList.copyOf(singleSlabBlocks);
	}

	public static Iterable<? extends StairsBlock> stairsBlocks() {
		return ImmutableList.copyOf(stairsBlocks);
	}

	public static Iterable<? extends SaplingBlock> saplingBlocks() {
