...
public enum OverworldTreeSpecies
	...
	@Override
	public void assignLeavesSubBlockVariant(Enum variant) {
		this.leavesVariant = variant;
	}
	...
	@Override
	public Enum leavesSubBlockVariant() {
		return leavesVariant;
	}
	...
	@Override
	public void assignLogSubBlockVariant(Enum variant) {
		this.logVariant = variant;
	}
	...
	@Override
	public Enum logSubBlockVariant() {
		return logVariant;
	}
	...
	@Override
	public Enum woodSubBlockVariant() {
		return planksVariant;
	}
	...
	@Override
	public void assignWoodSubBlockVariant(Enum type) {
		this.planksVariant = type;
	}
	...
	@Override
	public Enum stairsModelSubBlockVariant() {
		return woodSubBlockVariant();
	}
	...
	@Override
	public Block doorModelBlock() {
		return woodBlock();
	}

	@Override
	public Enum doorModelSubBlockVariant() {
		return woodSubBlockVariant();
	}
	...
	@Override
	public void assignSaplingSubBlockVariant(Enum type) {
		this.saplingVariant = type;
	}
	...
	@Override
	public Enum saplingSubBlockVariant() {
		return saplingVariant;
	}

	@Override
	@Deprecated
	public WorldGenerator treeGenerator() {
		return saplingTreeGen;
	}
	...
	@Override
	public void assignSlabSubBlockVariant(Enum slabMetadata) {
		this.slabVariant = slabMetadata;
	}
	...
	@Override
	public Enum slabSubBlockVariant() {
		return slabVariant;
	}
	...
	@Override
	public Enum slabModelSubBlockVariant() {
		return woodSubBlockVariant();
	}
