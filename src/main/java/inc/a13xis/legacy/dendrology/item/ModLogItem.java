...
public final class ModLogItem extends LogItem {
	...
	public ModLogItem(Block block, ModLogBlock log, String[] names) {
		super(block, log, names);
		this.logblock = log;
	}

	public ModLogItem(Block block, ModLog2Block log, String[] names) {
		super(block, log, names);
		this.logblock = log;
	}

	public ModLogItem(Block block, ModLog3Block log, String[] names) {
		super(block, log, names);
		this.logblock = log;
	}

	public ModLogItem(Block block, ModLog4Block log, String[] names) {
		super(block, log, names);
		this.logblock = log;
	}
